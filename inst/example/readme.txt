...
stored in a demo directory. Take a look at either example.bat or example.sh:
...
The main difference is that the gmt package does not aggregate all commands in a
single shell script, but calls them one by one using the R function system().
